...
namespace StudentManagerV2.Services
{
    public class StudentCabinet
    {
        ...
        private int _count = 0; // Tu ban dau chua co mon do, mang chua co value cho cac bien, cho cac phan tu, o day chinh la [i] = new Student() se la 1 value c]ho phan tu/bien thu [i] cua mang 
